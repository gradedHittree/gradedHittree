...
class EventData_lv2 : public EventData{
    public:
        ...
        void set_n_merged_signal(int _n_merged_signal){ n_merged_signal.push_back( _n_merged_signal); };
        ...
        int get_n_merged_signal(int i){ return n_merged_signal[i];};
        ...
        void deleteSignal(int i){
            ...
            n_merged_signal.erase(n_merged_signal.begin() + i);
    ...
    private:
        ...
        std::vector<int> n_merged_signal;
